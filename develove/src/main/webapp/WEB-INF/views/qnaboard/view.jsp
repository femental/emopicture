...
<div class="content-wrapper">
	...
	<div class="content-header" style="width:70%;margin-left:15%;">
        ...
        <ol class="breadcrumb" style="margin-bottom:0px; background-color:#F2DEDE;">
           ...
           <li class="active"><a href="/qnaboard/list">묻고답하기</a></li>
...
<script>
			...
			function getAllList(){   
			   var str = "";
			   $.getJSON("/qnareplies/" + bno, function(data){
			      $(data).each(
			            function(){
			...
			$("#replyDelBtn").on("click", function(){
			  ...
			  $.ajax({
			    ...
			    $("#list").on("click", function(){
			        var criform = $("#cri");
			    	criform.attr("action","/qnaboard/list").submit();
			    });
			    $("#mod").on("click", function(){
			        target.action="/qnaboard/modify";
			        target.submit();
			    });
			    $("#del").on("click", function(){
			        target.action="/qnaboard/delete";
			        target.method="post";
			        target.submit();
			    }); 
