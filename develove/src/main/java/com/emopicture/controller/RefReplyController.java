...
import com.emopicture.service.RefReplyService;

@RestController
@RequestMapping("/refreplies/*")
public class RefReplyController {

	@Inject
	private RefReplyService service;
	
	@Inject
	private RefBoardMapper bMapper;

	private static final Logger logger = LoggerFactory.getLogger(RefReplyController.class);
